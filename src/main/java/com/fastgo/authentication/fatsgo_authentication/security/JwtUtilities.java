...
import static com.fastgo.authentication.fatsgo_authentication.security.SecurityConstants.JWT_SECRET;
...
public class JwtUtilities {
   ...
   // public boolean hasRoleArtist(String token) {
   //     Claims claims = extractAllClaims(token);
   //     String role = (String) claims.get("role");
  //      return Role.ARTIST.toString().equals(role);
  //  }
